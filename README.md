...
- Categoría de empleado (Practicante, Trabajador o Administrador): cada una
  trae su propio horario y minutos de comida sugeridos al dar de alta —
  editable si ese empleado en particular es distinto.
- Exportación a CSV más amigable: incluye el día de la semana, la categoría
  del empleado, y un subtotal por persona además del total general.
- Imagen de marca ValeExpress: logo y colores oficiales (teal y verde) en
  toda la aplicación.
